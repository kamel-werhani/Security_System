...
# Copy the current directory contents into the container at /usr/src/ultralytics
COPY . .
...
RUN pip install supervision==0.2.1
...
# Run security_system_with_attachments.py when the container launches
CMD ["python", "./security_system_with_attachments.py"]
